            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-8">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="img/c22.jpg" alt="Cannon">
                            </a>
                        </div>
                    </div>
                                ...
                                <?php if(!isset($_SESSION['email'])){  ?>
                                        ...
                                        <?php
                                            ...
                                            if(check_if_added_to_cart(3)){
                                                ...
                                                ?>
                                                <a href="cart_add.php?id=3" class="btn btn-block btn-primary" name="add" value="add" class="btn btn-block btr-primary">Make Offer</a>
                                                <?php
                                            }
                                        }
                                        ?>
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-8">
                        <div class="thumbnail">
                            <h1>Volkswagen Polo (2012)</h1>
                            <h2>Diesel | 68.0km | Manual</h2>
                            <h3></h3><br><br>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4">
                        <div class="thumbnail">
                            <center>
                                <h3>HSR LAYOUT, BANGALURU</h3>
                                <p>Contact to owner :9876994865</p>
                                    </center>
                            <center>
                                <div class="caption">
                                    <?php if(!isset($_SESSION['email'])){  ?>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="thumbnail">
                            <h2>Description </h2>
                            <p>2013 Volkswagen Polo High line Diesel car, Red Col, Only And Only 68 km Done</p>
